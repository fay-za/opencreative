...
public final class IncrementStructureValueAction extends StructureAction {

    public IncrementStructureValueAction(Executor executor, Target target, int x, Arguments args) {
